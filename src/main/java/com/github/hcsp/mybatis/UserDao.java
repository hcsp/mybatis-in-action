...
public class UserDao {
    ...
    public Pagination<User> getUserByPage(String username, int pageSize, int pageNum) {
        try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
            ...
            hashMap.put("offset", pageSize * (pageNum - 1));
            hashMap.put("limit", pageSize);
            List<User> userList = sqlSession.selectList("com.github.hcsp.mybatis.userDoa.getUserByPage", hashMap);
            int total = sqlSession.selectOne("com.github.hcsp.mybatis.userDoa.countUser", username);
    ...
    public void batchInsertUsers(List<User> users) {
        try (SqlSession sqlSession = sqlSessionFactory.openSession(true)) {
            ...
            sqlSession.insert("com.github.hcsp.mybatis.userDoa.batchInsertUsers", hashMap);
        }
    }
    ...
    public void updateUser(User user) {
        try (SqlSession sqlSession = sqlSessionFactory.openSession(true)) {
            sqlSession.update("com.github.hcsp.mybatis.userDoa.updateUser", user);
        }
    }
    ...
    public void deleteUserById(Integer id) {
        try (SqlSession sqlSession = sqlSessionFactory.openSession(true)) {
            sqlSession.delete("com.github.hcsp.mybatis.userDoa.deleteUserById", id);
        }
    }
    ...
    public User selectUserById(Integer id) {
        try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
            return sqlSession.selectOne("com.github.hcsp.mybatis.userDoa.selectUserById", id);
        }
    }
}
