...
public class UserDao {
    ...
    public Pagination<User> getUserByPage(String username, int pageSize, int pageNum) {
        try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
            ...
            List<User> users = sqlSession.selectList("com.github.maxiaoda.MyMapper.getUserByPage", map);
            int count = sqlSession.selectOne("com.github.maxiaoda.MyMapper.countUser", username);
    ...
    public void batchInsertUsers(List<User> users) {
        try (SqlSession sqlSession = sqlSessionFactory.openSession(true)) {
            Map<String, Object> map = new HashMap<>();
            map.put("users", users);
            sqlSession.insert("com.github.maxiaoda.MyMapper.batchInsertUsers", map);
        }
    }
    ...
    public void updateUser(User user) {
        try (SqlSession sqlSession = sqlSessionFactory.openSession(true)) {
            sqlSession.update("com.github.maxiaoda.MyMapper.updateUser", user);
        }
    }
    ...
    public void deleteUserById(Integer id) {
        try (SqlSession sqlSession = sqlSessionFactory.openSession(true)) {
            sqlSession.delete("com.github.maxiaoda.MyMapper.deleteUserById", id);
        }
    }
    ...
    public User selectUserById(Integer id) {
        try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
            return sqlSession.selectOne("com.github.maxiaoda.MyMapper.selectUserById", id);
        }
    }
}
