...
public class UserDao {
    ...
    public Pagination<User> getUserByPage(String username, int pageSize, int pageNum) {
        try (SqlSession session = sqlSessionFactory.openSession()) {
            ...
            List<User> users = session.selectList("com.su.Mapper.selectUserName", map);
            int count = session.selectOne("com.su.Mapper.selectCountUser", username);
    ...
    public void batchInsertUsers(List<User> users) {
        try (SqlSession session = sqlSessionFactory.openSession(true)) {
            ...
            session.insert("com.su.Mapper.batchInsertUsers", param);
        }
    }
    ...
    public void updateUser(User user) {
        try (SqlSession session = sqlSessionFactory.openSession(true)) {
            session.update("com.su.Mapper.updateUser", user);
        }
    }
    ...
    public void deleteUserById(Integer id) {
        ...
        session.delete("com.su.Mapper.deleteUserById", id);
    }
    ...
    public User selectUserById(Integer id) {
        ...
        return session.selectOne("com.su.Mapper.selectUserById", id);
    }
}
