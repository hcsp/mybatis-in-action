...
public class UserDao {
    ...
    public Pagination<User> getUserByPage(String username, int pageSize, int pageNum) {
        ...
        try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
            List<User> users = sqlSession.selectList("com.hcsp.UserMapper.getUserByPage", params);
            int count = sqlSession.selectOne("com.hcsp.UserMapper.countUser", username);
            int totalPage = new BigDecimal(count)
    ...
    public void batchInsertUsers(List<User> users) {
        try (SqlSession sqlSession = sqlSessionFactory.openSession(true)) {
            sqlSession.insert("com.hcsp.UserMapper.batchInsertUsers", users);
        }
    }
    ...
    public void updateUser(User user) {
        try (SqlSession sqlSession = sqlSessionFactory.openSession(true)) {
            sqlSession.insert("com.hcsp.UserMapper.updateUser", user);
        }
    }
