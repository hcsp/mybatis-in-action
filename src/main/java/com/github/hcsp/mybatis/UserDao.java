...
public class UserDao {
    ...
    public Pagination<User> getUserByPage(String username, int pageSize, int pageNum) {
        ...
        try (SqlSession session = sqlSessionFactory.openSession()) {
            List<User> list = session.selectList("db.mybatis.myMapper.getUserByPage", map);
            int count = session.selectOne("db.mybatis.myMapper.countUser", username);
    ...
    public void batchInsertUsers(List<User> users) {
        ...
        try (SqlSession sqlSession = sqlSessionFactory.openSession(true)) {
            sqlSession.insert("db.mybatis.myMapper.batchInsertUsers", map);
        }
    ...
    public void updateUser(User user) {
        try (SqlSession sqlSession = sqlSessionFactory.openSession(true)) {
            sqlSession.insert("db.mybatis.myMapper.updateUser", user);
        }
    }
