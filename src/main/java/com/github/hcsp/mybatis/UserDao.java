...
public class UserDao {
    ...
    /**
     * 根据传入的参数搜索用户名包含username的用户，返回分页后的结果。
     *
     * @param username 传入的搜索参数
     * @param pageSize 分页搜索，每页显示的条数
     * @param pageNum 分页的页码，从1开始
     * @return 搜索结果，若username为null，则返回所有用户的列表
     */
    public Pagination<User> search(String username, int pageSize, int pageNum) {
        return null;
    }
