...
public class UserDao {
    ...
    public Pagination<User> getUserByPage(String username, int pageSize, int pageNum) {
        try (SqlSession session = sqlSessionFactory.openSession()) {
            ...
            List<User> users = session.selectList("com.hcsp.Mapper.getUserPaging", map);
            int count = session.selectOne("com.hcsp.Mapper.countUser", username);
    ...
    public void batchInsertUsers(List<User> users) {
        try (SqlSession session = sqlSessionFactory.openSession(true)) {
            Map<String, Object> map = new HashMap<>();
            map.put("users", users);
            session.insert("com.hcsp.Mapper.insertUsers", map);
        }
    }
    ...
    public void updateUser(User user) {
        try (SqlSession session = sqlSessionFactory.openSession(true)) {
            session.insert("com.hcsp.Mapper.updateUser", user);
        }
    }
    ...
    public void deleteUserById(Integer id) {
        try (SqlSession session = sqlSessionFactory.openSession(true)) {
            Map<String, Object> map = new HashMap<>();
            map.put("id", id);
            session.delete("com.hcsp.Mapper.deleteUserById", map);
        }
    }
    ...
    public User selectUserById(Integer id) {
        try (SqlSession session = sqlSessionFactory.openSession()) {
            Map<String, Object> map = new HashMap<>();
            map.put("id", id);
            return session.selectOne("com.hcsp.Mapper.selectUserById", map);
        }
    }
}
