...
public class UserDao {
    ...
    public Pagination<User> getUserByPage(String username, int pageSize, int pageNum) {
        try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
            ...
            usermap.put("offset", (pageNum - 1) * pageSize);
            usermap.put("limit", pageSize);
            List<User> users = sqlSession.selectList("Mapper.getUserByPage", usermap);

            int count = sqlSession.selectOne("Mapper.countUser", username);
    ...
    public void deleteUserById(Integer id) {
        try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
            sqlSession.selectOne("Mapper.deleteUserById", id);
//            DeleteMap mapper = sqlSession.getMapper(DeleteMap.class);
//            mapper.deleteMapper(id);
    ...
    interface DeleteMap {
        ...
        void deleteMapper(@Param("id") Integer id);
    }
