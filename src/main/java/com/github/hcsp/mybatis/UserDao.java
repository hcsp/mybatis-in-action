...
public class UserDao {
    ...
    public Pagination<User> getUserByPage(String username, int pageSize, int pageNum) {
        try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
            ...
            List<User> result = sqlSession.selectList("com.github.wjinlei.mapper.getUserByPage", param);
            int count = sqlSession.selectOne("com.github.wjinlei.mapper.countByUsername", username);
            int totalPage = (count & pageSize) == 0 ? count / pageSize : count / pageSize + 1;
            return Pagination.pageOf(result, pageSize, pageNum, totalPage);
        }
    }
    ...
    public void batchInsertUsers(List<User> users) {
        try (SqlSession sqlSession = sqlSessionFactory.openSession(true)) {
            ...
            sqlSession.insert("com.github.wjinlei.mapper.batchInsertUsers", param);
        }
    }
    ...
    public void updateUser(User user) {
        try (SqlSession sqlSession = sqlSessionFactory.openSession(true)) {
            sqlSession.update("com.github.wjinlei.mapper.updateUser", user);
        }
    }
    ...
    public void deleteUserById(Integer id) {
        try (SqlSession sqlSession = sqlSessionFactory.openSession(true)) {
            sqlSession.delete("com.github.wjinlei.mapper.deleteUserById", id);
        }
    }
    ...
    public User selectUserById(Integer id) {
        try (SqlSession sqlSession = sqlSessionFactory.openSession()) {
            return sqlSession.selectOne("com.github.wjinlei.mapper.selectUserById", id);
        }
    }
}
