...
public class UserDao {
    ...
    public Pagination<User> getUserByPage(String username, int pageSize, int pageNum) {
        ...
        List<User> result = sqlSessionFactory.openSession().selectList("getUserByPage", params);
        int totalPage = sqlSessionFactory.openSession().selectOne("getUserCount", params);
        return Pagination.pageOf(result, pageSize, pageNum, totalPage % pageSize == 0 ? totalPage / pageSize : totalPage / pageSize + 1);
    }
    ...
    public void batchInsertUsers(List<User> users) {
        ...
        sqlSession.insert("batchInsertUsers", params);
        sqlSession.commit();
    }
    ...
    public User selectUserById(Integer id) {
        return sqlSessionFactory.openSession().selectOne("selectUserById", id);
    }
}
