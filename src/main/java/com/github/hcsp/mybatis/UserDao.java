...
public class UserDao {
    ...
    public Pagination<User> getUserByPage(String username, int pageSize, int pageNum) {
        ...
        int totalPage = session.selectOne("com.github.hcsp.mybatis.UserDao.getTotalPage", map);
        List<User> list = session.selectList("com.github.hcsp.mybatis.UserDao.getUserList", map);
    ...
    public void batchInsertUsers(List<User> users) {
        ...
        for (User user : users) {
            session.insert("com.github.hcsp.mybatis.UserDao.batchInsertUsers", user);
        }
        session.commit();
    }
    ...
    public void updateUser(User user) {
        if (user.getId() != null) {
            SqlSession session = sqlSessionFactory.openSession(true);
            System.out.println(session.update("com.github.hcsp.mybatis.UserDao.updateUser", user));
        }
    }
    ...
    public void deleteUserById(Integer id) {
        SqlSession session = sqlSessionFactory.openSession(true);
        session.delete("com.github.hcsp.mybatis.UserDao.deleteUserById", id);
    }
    ...
    public User selectUserById(Integer id) {
        SqlSession session = sqlSessionFactory.openSession(true);
        return session.selectOne("com.github.hcsp.mybatis.UserDao.selectUserById", id);
    }
}
