...
public class UserDao {
    ...
    public Pagination<User> getUserByPage(String username, int pageSize, int pageNum) {
        try (SqlSession session = sqlSessionFactory.openSession()) {
            ...
            List<User> users = session.selectList("com.github.hcsp.selectUsers", params);
            int totalPage = session.selectOne("com.github.hcsp.countUsers", params);
    ...
    public void batchInsertUsers(List<User> users) {
        try (SqlSession session = sqlSessionFactory.openSession(true)) {
            ...
            session.insert("com.github.hcsp.insertUsers", params);
        }
    ...
    public void updateUser(User user) {
        try (SqlSession session = sqlSessionFactory.openSession(true)) {
            session.update("com.github.hcsp.updateUserIfNecessary", user);
        }
    }
    ...
    public void deleteUserById(Integer id) {
        try (SqlSession session = sqlSessionFactory.openSession(true)) {
            session.delete("com.github.hcsp.deleteUser", id);
        }
    }
    ...
    public User selectUserById(Integer id) {
        try (SqlSession session = sqlSessionFactory.openSession()) {
            User user = session.selectOne("com.github.hcsp.selectUserById", id);
            return user;
        }
    }
